...
def init(puzzle) :
    ...
    arg: the puzzle solving module to be used, eg. 2016_01
    prints: puzzle title'''
...
def print_statistics(year) :
    ...
    runtime = worktime = 0
    print ("Advent of Code 2016                               Tests [run time]  Puzzle [Difficulty, work time, run time]      lessons learned")
    print ("---------------------------------------------------------------------------------------------------------------------------------------")
    ...
    print ("---------------------------------------------------------------------------------------------------------------------------------------")
    print (f"Advent of Code 2016 Total:   work {worktime//60}h{worktime%60}m,   runtime {runtime} seconds")