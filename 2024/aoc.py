...
def print_statistics(year) :
    ...
    runtime = worktime = 0
    print ("Advent of Code 2024                               Tests [run time]  Puzzle [Difficulty, work time, run time]      lessons learned")
    print ("---------------------------------------------------------------------------------------------------------------------------------------")
    ...
    print ("---------------------------------------------------------------------------------------------------------------------------------------")
    print (f"Advent of Code 2024 Total:   work {worktime//60}h{worktime%60}m,   runtime {runtime} seconds")