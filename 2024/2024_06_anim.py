...
def guard_walk(g, pos, dir) :
    a = anim.AnimGrid(anim.Screen(1300,1350, 'Guard Walk'), g.dim_x, g.dim_y, use_chars=False,  status_area=50,\
    title='Guard Gallivant: let\'em walk')#, movie = "AOC_2024-06_Guard-Walk")
    a.color_map['.'] = 'BLACK'
    a.draw(g, 500)
...
def solve(aoc_input, part1=True, part2=True, attr=None) :
    ...
    # Part one: let the guard walk of the grid: visited positions are X'ed
    g1 = Grid.copy(g)
